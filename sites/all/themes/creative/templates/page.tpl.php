...
<header id="header">
  ...
  <div class="layout-978">
    ...
    <?php if (theme_get_setting('socialicon_display', 'creative')): ?>
      <?php 
      $twitter_url = theme_get_setting('twitter_url', 'creative'); 
      $facebook_url = theme_get_setting('facebook_url', 'creative'); 
      $google_plus_url = theme_get_setting('google_plus_url', 'creative'); 
      $pinterest_url = theme_get_setting('pinterest_url', 'creative');
      ?>
...
<div id="footer">
  ...
  <div id="sitelock_shield_logo" class="fixed_btm"><a href="https://www.sitelock.com/verify.php?site=clubedoquiz.com" onclick="window.open('https://www.sitelock.com/verify.php?site=clubedoquiz.com','SiteLock','width=600,height=600,left=160,top=170');return false;" ><img alt="malware removal and website security" title="SiteLock"  src="//shield.sitelock.com/sshield/clubedoquiz.com"/></a></div>
</div>
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-38488293-1']);
